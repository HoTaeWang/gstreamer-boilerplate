...
typedef struct _CustomData {
	...
	gboolean seek_done;     /* Have we performed this seek already? */
	...
	do{
		...
		if(NULL != msg){
			...
			if(data.playing){
				...
				/* if seeking is enable, we have not done it yet, and the time is right, seek */
